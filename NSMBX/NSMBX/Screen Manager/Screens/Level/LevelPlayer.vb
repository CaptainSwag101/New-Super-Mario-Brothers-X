Partial Public Class LevelScreen

    ' SCREEN POSITION
    Public PlayerScreenX As Integer = 10
    Public PlayerScreenY As Integer = 6

    ' PLAYER'S MAP COORDINATES
    Public PlayerX As Integer = 0
    Public PlayerY As Integer = 0

    ' PLAYER'S MAP OFFSET - SMOOTH WALKING
    ...
    Public XSpeed As Float
	Public YSpeed As Float
	Public JumpSpeed As Integer = 6 ' WHEN THE PLAYER JUMPS, YSpeed IS SET TO THIS VALUE, THEN SLOWLY DECREASES WITH GRAVITY
